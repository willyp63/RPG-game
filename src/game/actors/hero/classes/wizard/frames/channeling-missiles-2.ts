...
const CHANNELING_MISSILES_2: HPSkeletalFrame = {
  pivots: {
    [FRONT_UPPER_ARM_ID]: Math.PI / -3,
    [FRONT_LOWER_ARM_ID]: Math.PI / -3,
    [BACK_UPPER_ARM_ID]: Math.PI / -6,
    [BACK_LOWER_ARM_ID]: Math.PI * -2 / 3,
...
export default CHANNELING_MISSILES_2;
